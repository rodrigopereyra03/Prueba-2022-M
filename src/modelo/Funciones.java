...
public class Funciones {
	...
	public static boolean esFechaValida (LocalDate fecha) {
			...
			boolean treintaYUno = ((fecha.getMonthValue()%2!=0 && fecha.getMonthValue()<=7) || (fecha.getMonthValue()>=8 && fecha.getMonthValue()%2==0)) && fecha.getMonthValue()!=2;
			boolean treinta = ((fecha.getMonthValue()%2==0 && fecha.getMonthValue()<=6) || (fecha.getMonthValue()%2!=0 && fecha.getMonthValue()>=9)) && fecha.getMonthValue()!=2;
